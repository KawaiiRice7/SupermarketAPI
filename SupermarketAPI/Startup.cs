...
namespace SupermarketAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Add objectfactory and register instances here.
            string connectionString = Configuration["DbConnectionString"];

            Common.ObjectFactory.RegisterInstance<CoreDomain.Services.ICategoryRepository>(new CategoryRepository(connectionString));
